...
<head>
    ...
    <title>Rangos - Sistema Taberna</title>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="agregar_rangos.php" class="btn btn-primary">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0">
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <a href="editar_rangos.php?id=<?=$key['idRangos'] ?>">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                        </td>
                                        <td><?= $key['idRangos'] ?></td>
                                        <td><?= $key['nombreRango'] ?></td>
                                        <td><?= $key['nivelRango'] ?></td>
                                        <td><?= $key['estadoRango'] ?></td>
                                    </tr>
